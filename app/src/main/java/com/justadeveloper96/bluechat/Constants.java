...
public class Constants {
    ...
    @Retention(SOURCE)
    @IntDef({STATUS_CONNECTING,STATUS_CONNECTED,STATUS_CONNECTING_FAILED,STATUS_LISTENING,STATUS_LISTENING_FAILED,STATUS_DISCONNECTED})
    public @interface ChatStatusConstants{}

    public static String[] ERROR_MSG={"CONNECTING","CONNECTED","CONNECTION FAILED","LISTENING","LISTENING FAILED","DISCONNECTED"};
